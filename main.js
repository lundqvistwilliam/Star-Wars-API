...
class Character{
  ...
  if(dataGot === false){
    ...
    compareBtn.addEventListener("click", () => {
      ...
      //   li.innerHTML=character1.movies;
      //   document.getElementById("movies1").append("li")
      // }
      

      document.getElementById("movies1").innerHTML=`${character1.movies}  (${character1.movies.length})`
      ...
      //   let li = document.createElement("li");
      //   li.innerHTML=character2.movies;
      //   document.getElementById("movies1").append("li")
      // }
      document.getElementById("movies2").innerHTML=`${character2.movies}  (${character2.movies.length})`
...
function setGradients(){
  ...
  if(character1.eyeColor === character2.eyeColor){
   ...
   if(character1.movies.length > character2.movies.length){
     document.getElementById("moviesTexts").style.background ="linear-gradient(to right, " + "green" + ", " + "green" + ")";
     ...
     document.getElementById("moviesTexts").style.background ="linear-gradient(to left, " + "green" + ", " + "green" + ")";
     document.getElementById("movies1").style.color="white"
     document.getElementById("movies2").style.color="white"
   } else {
